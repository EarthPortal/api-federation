...
public class ArtefactDataServiceTest extends ApplicationTestAbstract {
    ...
    public void testGetTerm() {
        ...
        AggregatedApiResponse response = (AggregatedApiResponse) artefactsService.getArtefactTerm("skosmos", "AGROVOC", "http://aims.fao.org/aos/agrovoc/c_330834", params, apiAccessor);
        assertMapEquality(response, createSkosmosAgrovocTerm());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("ontoportal", "AGROVOC", "http://aims.fao.org/aos/agrovoc/c_330834", params, apiAccessor);
        assertMapEquality(response, createOntoPortalAgrovocTermFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("ols2", "ncbitaxon", "http://purl.obolibrary.org/obo/NCBITaxon_2", params, apiAccessor);
        assertMapEquality(response, createOls2NCBITaxonFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("ols", "ncbitaxon", "http://purl.obolibrary.org/obo/NCBITaxon_2", params, apiAccessor);
        assertMapEquality(response, createNCBITaxonFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("gnd", "gnd", "4074335-4", params, apiAccessor);
        assertMapEquality(response, createGndTermFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("jskos", "test", "http://superdatensatz.gbv.de/abc", params, apiAccessor);
        assertMapEquality(response, createdDanteTermFixture());

        response = (AggregatedApiResponse) artefactsService.getArtefactTerm("jskos2", "DDC", "http://dewey.info/class/612.112/e23/", params, apiAccessor);
    ...
    public void testGetProperty() {
        ...
        CommonRequestParams params = new CommonRequestParams();
        AggregatedApiResponse response = (AggregatedApiResponse) artefactsService.getArtefactProperty("ontoportal", "AGROVOC", "http://purl.org/dc/terms/abstract", params, apiAccessor);
        assertMapEquality(response, createOntoPortalAgrovocPropertyFixture());


        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactProperty("ols", "NCBITAXON", "http://purl.obolibrary.org/obo/ncbitaxon#has_rank", params, apiAccessor);
        assertMapEquality(response, createOlsNCBITaxonPropertyFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactProperty("ols2", "NCBITAXON", "http://purl.obolibrary.org/obo/ncbitaxon#has_rank", params, apiAccessor);
    ...
    public void testGetCollection() {
        ...
        AggregatedApiResponse response = (AggregatedApiResponse) artefactsService.getArtefactCollection("ontoportal", "INRAETHES", "http://opendata.inrae.fr/thesaurusINRAE/gr_6c79e7c5", new CommonRequestParams(), apiAccessor);
    ...
    public void testGetIndividuals() {
        ...
        CommonRequestParams params = new CommonRequestParams();
        AggregatedApiResponse response = (AggregatedApiResponse) artefactsService.getArtefactIndividual("ols2", "FOODON", "http://purl.obolibrary.org/obo/GAZ_00000464", params, apiAccessor);
        assertMapEquality(response, createOls2FoodOnInstanceFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactIndividual("ontoportal", "FOODON", "http://purl.obolibrary.org/obo/GAZ_00000464", params, apiAccessor);
        assertMapEquality(response, createOntoPortalFoodOnInstanceFixture());

        params = new CommonRequestParams();
        response = (AggregatedApiResponse) artefactsService.getArtefactIndividual("ols", "FOODON", "http://purl.obolibrary.org/obo/GAZ_00000464", params, apiAccessor);
    ...
    public void testGetScheme() {
        ...
        AggregatedApiResponse response = (AggregatedApiResponse) artefactsService.getArtefactScheme("ontoportal", "INRAETHES", "http://opendata.inrae.fr/thesaurusINRAE/mt_50", new CommonRequestParams(), apiAccessor);
